...
- date dans planning ==> FAIT 
- commenter fonctions + mettre de l'odre
- completer formulaire
- Praticienplanning, acceuil nav tab a propriser && dynamisr surtout ! ======> FAIT
- Creation Praticien a test par formulaire, GetDatesFromNow() ====> FAIT
- faire fonction foreach date & hours dans generateDate(). =====> FAIT
